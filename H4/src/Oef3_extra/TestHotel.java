...
// wat gebeurt er bij new ? aanmaken van een nieuw object van deze klasse
		...
		Gast gast2=new Gast("Zoons Pieter","Nederland", new Kamer());
		Gast gast3=new Gast(3, "Peeters Wim","Duitsland", new Kamer());
		Gast gast5 = new Gast(args[0], args[1], new Kamer());
// vergelijk de new van gast1,gast2,gast3 	Constructor overloading
		
		gast1.wijzigLand("Belgie");
